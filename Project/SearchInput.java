...
//Date: June 15, 2016
//Description: SearchInput gets the text field input from the user for the item to be searched.


import java.io.*;

/** SearchInput gets the text field input from the user for the item to be searched.
