...
//Date: June 15, 2016
//Description: Receipt is called by the Output.java to print out the record for the current customer.

class Receipt

/** Receipt is called by the Output.java to print out the record for the current customer.
